...
// you'll need these:
import {generate} from 'til-client-test-utils' // Generates random login details
...
test('calls onSubmit with the username and password when submitted', () => {
  ...
  const formNode = container.querySelector('form'); // Probably safe to assume only one form on the page
